...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2015 at 04:48 AM
...
--
-- Truncate table before insert `form_responses`
--
...
--
-- Truncate table before insert `form_response_entries`
--

TRUNCATE TABLE `form_response_entries`;
--
...
--
-- Truncate table before insert `sample_object`
--

TRUNCATE TABLE `sample_object`;
--
