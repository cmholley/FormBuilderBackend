...
public class FormEntity implements Serializable {
	...
	public FormEntity(Long id, String name, String subtitle, Date insertion_date, Set<Question> questions,
			boolean publi, boolean enabled, THEME theme, boolean redirect_to_url, boolean send_notification,
			boolean send_receipt, String email_message, String completed_message, String redirect_url,
